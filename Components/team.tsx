...
import Pic from "../public/images/hamza pic.jpg" 
import Image from 'next/image'
import Qayum from '../public/images/qyum.jpg'
        ...
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
         ...
         <Image
          ...
          <div className="flex-grow sm:pl-8">
            <h2 className="title-font font-medium text-lg text-gray-900">Muhammad Hamza</h2>
            <h3 className="text-gray-500 mb-3">React Js  Developer</h3>
